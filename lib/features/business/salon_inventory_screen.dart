...
class SalonInventoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final inventory = [
      {'name': 'Organic Argan Shampoo 500ml', 'stock': 24, 'min': 10, 'price': '\$18.00'},
      {'name': 'Matte Hair Clay 100g', 'stock': 4, 'min': 8, 'price': '\$22.00'},
    ];
          ...
          return Padding(
            ...
            child: GlassCard(
              child: ListTile(
                ...
                subtitle: Text('In Stock: ${item['stock']} units • Price: ${item['price']}'),
                trailing: isLow
                    ? Container(
