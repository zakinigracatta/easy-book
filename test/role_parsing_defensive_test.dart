...
void main() {
  group('Scenario 6: Role Parsing & Defensive Authorization Tests', () {
    ...
    test(
        '5. Unknown role "superadmin" does not escalate privileges to admin or owner',
        () {
    ...
    test(
        '6. Malformed and unexpected role values map safely to UserRole.customer',
        () {
      final inputs = [
        'ADMIN',
        'OWNER',
    ...
    test(
        '7. Numeric and boolean string role payloads map safely to UserRole.customer',
        () {
